...
export default function RareFailures() {
  ...
  return (
    <div className="bg-cyan-600 min-h-screen py-16 px-4 md:px-24 outline-8 -outline-offset-8 outline-lime-200/70 md:outline-16 md:-outline-offset-16">
      <div>
