...
export default function Ranking() {
  ...
  return (
    <div className="flex flex-col items-center gap-8 mb-8 bg-white min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-2 px-4 w-full md:px-8">
        {/* レア失敗ランキング */}
        {rankingResults ? (
          <div
          ...
          <div className="flex items-center justify-center w-full text-gray-500 mt-8">
            <p>ランキングデータを読み込み中...</p>
          </div>
        )}
                ...
                <div className="flex items-end justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="font-semibold text-gray-800 text-xl">
                      {rankingResults.bottom.userName || "匿名"}
                    </div>
                  </div>
